...
route.put('/barbeiro/:id', BarbeiroController.updateBarbeiro);
...
route.put('/agendamento/:id', AgendamentoController.updateAgendamento);
...
route.put('/atendente/:id', AtendenteController.updateAtendente);
...
route.put('/servicos/:id', ServicoController.updateServico);
